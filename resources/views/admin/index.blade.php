            ...
            <div id="dashboard-page" class="page">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <div class="mt-2">
                            <span class="text-accent text-sm">+2 this month</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <div class="mt-2">
                            <span class="text-accent text-sm">+5 today</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <div class="mt-2">
                            <span class="text-accent text-sm">+12% from last month</span>
                        </div>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-accent font-semibold">$180</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-accent font-semibold">$105</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-accent font-semibold">$260</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button id="quick-add-product" class="p-4 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-primary hover:bg-primary/10 transition duration-300">
                                <i class="fas fa-plus text-2xl text-gray-400 mx-auto mb-2"></i>
                                <p class="text-sm font-medium">Add Product</p>
                            </button>

                            <button class="p-4 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-secondary hover:bg-secondary/10 transition duration-300">
                                <i class="fas fa-file-alt text-2xl text-gray-400 mx-auto mb-2"></i>
                                <p class="text-sm font-medium">New Order</p>
                            </button>

                            <button class="p-4 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-accent hover:bg-accent/10 transition duration-300">
                                <i class="fas fa-user-plus text-2xl text-gray-400 mx-auto mb-2"></i>
                                <p class="text-sm font-medium">Add Customer</p>
                            </button>

                            <button class="p-4 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-neutral hover:bg-neutral/10 transition duration-300">
