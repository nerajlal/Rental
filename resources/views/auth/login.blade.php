    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        ...
        <form method="POST" action="{{ url('/admin/login') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" id="username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required autofocus>
            </div>
            <div class="mb-6">
