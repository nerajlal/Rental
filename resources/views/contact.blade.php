            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="font-semibold text-lg flex items-center gap-3"><i class="fab fa-whatsapp text-orange-500"></i> WhatsApp</h4>
                            <p class="text-gray-600 mt-2"><a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $siteConfig['business']['whatsapp']) }}" target="_blank" class="hover:text-orange-600">{{ $siteConfig['business']['whatsapp'] }}</a></p>
                        </div>
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="font-semibold text-lg flex items-center gap-3"><i class="fab fa-instagram text-orange-500"></i> Instagram</h4>
                            <p class="text-gray-600 mt-2"><a href="{{ $siteConfig['business']['instagram'] }}" target="_blank" class="hover:text-orange-600">Follow us on Instagram</a></p>
                        </div>
                    </div>
                </div>
            </div>
