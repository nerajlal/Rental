@include('head')
    ...
    <main class="pt-16" id="main-content">
        <!-- Contact Page -->
        <section class="py-16 px-4 bg-gradient-to-br from-primary/10 via-red-50 to-primary/20 min-h-screen relative overflow-hidden">
            ...
            <div class="absolute inset-0 opacity-10">
                ...
                <div class="absolute top-1/2 left-1/4 w-24 h-24 bg-primary/70 rounded-full blur-2xl animate-pulse" style="animation-delay: 1s;"></div>
            </div>

            <div class="max-w-7xl mx-auto relative z-10">
                <!-- Header Section -->
                <div class="text-center mb-16">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-red-500 rounded-2xl mb-6 shadow-lg">
                        <i class="fas fa-envelope text-2xl text-white"></i>
                    </div>
                    <h2 class="text-5xl lg:text-6xl font-bold text-gray-800 mb-6 tracking-tight">
                        Contact <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-red-600">Us</span>
                    </h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        We'd love to hear from you! Whether you have a question about our products, pricing, or anything else, our team is ready to answer all your questions.
                    </p>
                    <div class="w-32 h-1 bg-gradient-to-r from-primary to-red-500 mx-auto mt-8 rounded-full"></div>
                </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white/90 backdrop-blur-sm p-8 lg:p-12 rounded-3xl shadow-2xl border border-white/20">
                            <div class="flex items-center mb-8">
                                <div class="w-12 h-12 bg-gradient-to-br from-primary to-red-500 rounded-xl flex items-center justify-center mr-4 shadow-lg">
                            ...
                            <form action="{{ route('contact.submit') }}" method="POST" class="space-y-8">
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div class="group">
                                        <label for="name" class="block text-sm font-bold text-gray-700 mb-3 transition-colors group-focus-within:text-primary">
                                            <i class="fas fa-user mr-2 text-primary"></i>Full Name *
                                        </label>
                                        <input type="text" name="name" id="name" required 
                                               class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 bg-gray-50 focus:bg-white hover:border-gray-300 text-gray-800 font-medium">
                                    </div>
                                    
                                    <div class="group">
                                        <label for="email" class="block text-sm font-bold text-gray-700 mb-3 transition-colors group-focus-within:text-primary">
                                ...
                                <div class="group">
                                    <label for="subject" class="block text-sm font-bold text-gray-700 mb-3 transition-colors group-focus-within:text-primary">
                                ...
                                <div class="group">
                                    <label for="message" class="block text-sm font-bold text-gray-700 mb-3 transition-colors group-focus-within:text-primary">
                                        <i class="fas fa-comment-dots mr-2 text-primary"></i>Message *
                                    </label>
                                    <textarea name="message" id="message" rows="6" required 
                                              placeholder="Tell us about your requirements in detail..."
                                              class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 bg-gray-50 focus:bg-white hover:border-gray-300 resize-none text-gray-800 font-medium"></textarea>
                                </div>
                                
                                <div class="pt-4">
                                    <button type="submit" 
                                            class="w-full bg-gradient-to-r from-primary to-red-600 hover:from-primaryHover hover:to-red-700 text-white font-bold py-5 px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl active:scale-[0.98] flex items-center justify-center space-x-3 text-lg">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <div class="flex items-center space-x-4">
                                <div class="w-14 h-14 bg-gradient-to-br from-primary to-primaryHover text-white rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600">
                                        <a href="tel:{{ $siteConfig['business']['phone'] }}" 
                                           class="hover:text-primary transition-colors font-semibold flex items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600">
                                        <a href="mailto:{{ $siteConfig['business']['email'] }}" 
                                           class="hover:text-primary transition-colors font-semibold break-all flex items-center">
                        ...
                        <!-- Call to Action Card -->
                        <div class="bg-gradient-to-br from-primary to-red-600 p-6 rounded-2xl shadow-lg text-white mt-8">
