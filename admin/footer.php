    ...
    <div id="upgrade-benefits-modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 modal-overlay">
        <div class="bg-white p-8 rounded-lg shadow-2xl w-full max-w-lg fade-in">
            <div class="text-center">
                <i class="fas fa-rocket text-5xl text-orange-500 mb-4"></i>
            ...
            <div class="mt-8 flex flex-col items-center">
                <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $siteConfig['business']['whatsapp']); ?>" target="_blank" class="w-full text-center px-6 py-3 bg-green-500 text-white rounded-md text-lg font-semibold hover:bg-green-600 transition duration-300">
